...
<svg xmlns="http://www.w3.org/2000/svg"
     ...
     width="800mm" height="600mm"
     viewBox="-400 -300 800 600">
  <title>Mein SVG PP3</title>
  <desc>Erstellung einer Linie, Kreis und Rechteck</desc>
...
<details>
    ...
    "#" erzeugen Überschriften. Wenn man mehr "#" davor setzt, desto kleiner und untergeordneter wird die Überschrift:
...
<details>
    ...
    <code>
    Schrift in kursiv oder fett Anzeigen lassen:
...
1. Ungeordnete Liste:
Diese werden mit "-" oder "*" erstellt.

2. Geordnete Liste:
Diese werden mit Zahlen (z.B. 1. / 2.) erstellt.

3.Tabelle:
Mit "|" werden Spalten erstellt und "-" die Trennung von Kopfzeile und Inhalt.
...
bei \section{intro} nach \maketitle wird:
-neue Überschrift "Intro" wird angezeigt
</details>
